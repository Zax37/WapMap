...
{
    return GV->editState->RenderObject(hObject, GV->editState->Wrd2ScrXrb(GV->editState->plMain, GetUserDataFromObj(hObject)->GetX()),
                                                GV->editState->Wrd2ScrYrb(GV->editState->plMain, GetUserDataFromObj(hObject)->GetY()),
                                                0xFFFFFFFF);
}

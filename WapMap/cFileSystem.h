...
class cFileFeed
{
 ...
 public:
  ...
  virtual unsigned char * GetFileContent(const char * path, unsigned int &oiDataLength, unsigned int iReadStart = 0, unsigned int iReadLen = 0){ oiDataLength = 0; return NULL; };
  ...
  virtual std::vector<std::string> GetDirectoryContents(const char * path, bool bRecursive){ return std::vector<std::string>(); };
  virtual std::vector<std::string> GetFilesInDirectory(std::string strDirectory){ return std::vector<std::string>(); };
  virtual std::vector<std::string> GetDirsInDirectory(std::string strDirectory){ return std::vector<std::string>(); };
...
class cDiscFeed : public cFileFeed
{
 ...
 public:
  ...
  virtual unsigned char * GetFileContent(const char * path, unsigned int &oiDataLength, unsigned int iReadStart = 0, unsigned int iReadLen = 0);
  virtual void SetFileContent(const char * path, std::string strContent);

...
void State::MapStats::Init()
{
	...
	conMain->add(winStat, hge->System_GetState(HGE_SCREENWIDTH) / 2 - 320, hge->System_GetState(HGE_SCREENHEIGHT) / 2 - 240);
	...
	iPerfectNeed = treasures[0] * 100 + treasures[1] * 500 + treasures[2] * 1500 + treasures[3] * 2500 + treasures[4] * 2500 +
		treasures[5] * 5000 + treasures[6] * 7500 + treasures[7] * 10000 + treasures[8] * 15000 + treasures[9] * 25000;

...
void State::EditingWW::FirstRun_Open()
{
	...
	int height = 20;//GV->fntMyriad13->GetHeightb(370, GETL2S("FirstRun", "Text"));
...
void State::EditingWW::FirstRun_Think()
{
	...
	GV->fntMyriad13->printfb(wx + 15, wy + 25, 370, 500, HGETEXT_LEFT | HGETEXT_TOP, GETL2S("FirstRun", "Text"));
}

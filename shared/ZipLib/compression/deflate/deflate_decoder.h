...
public:
    ...
    basic_deflate_decoder()
            : _lastError(Z_OK), _stream(nullptr), _endOfStream(false), _bufferCapacity(0), _inputBufferSize(0),
              _outputBufferSize(0), _inputBuffer(nullptr), _outputBuffer(nullptr), _bytesRead(0), _bytesWritten(0) {

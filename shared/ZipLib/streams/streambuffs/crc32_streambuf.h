...
public:
    ...
    crc32_streambuf()
            : _inputStream(nullptr), _internalBufferPosition(_internalBuffer + INTERNAL_BUFFER_SIZE),
              _internalBufferEnd(_internalBuffer + INTERNAL_BUFFER_SIZE), _bytesRead(0), _crc32(0) {

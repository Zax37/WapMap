...
public:
    ...
    basic_compression_encoder_stream(icompression_encoder_ptr_type compressionEncoder,
                                     compression_encoder_properties_interface &props, ostream_type &stream)
            : std::basic_ostream<ELEM_TYPE, TRAITS_TYPE>(&_compressionEncoderStreambuf),
    ...
    void init(icompression_encoder_ptr_type compressionEncoder, compression_encoder_properties_interface &props,
              ostream_type &stream) {

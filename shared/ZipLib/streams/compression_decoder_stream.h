...
public:
    ...
    basic_compression_decoder_stream(icompression_decoder_ptr_type compressionDecoder,
    ...
    bool init(icompression_decoder_ptr_type compressionDecoder, compression_decoder_properties_interface &props,
              istream_type &stream) {
